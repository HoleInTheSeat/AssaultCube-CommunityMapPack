****************************************************************************
Barrel_ice and tree_snow mapmodels are from makKe (c) (All rights reserved)
=> deathstar adapted the mapmodels skins for his map.
...
*****************************************************************************
 LICENSE:
*****************************************************************************
Actioncube Mapmodels

--------------------------------------------------------------------------------------------------
These mapmodels have been created for Actioncube. 

modelled by Shane Nieb :
...
(!) Laptop model+skin by  (c) 2004 by JCDPC, all rights reserved. (!)

All other objects modelled and skinned by makkE.

---------------------------------------------------------------------------------------------------

LICENSE
===========
Files in this folder and subfolders (as stated above):
